...
public class MenuPanel extends JPanel {
	...
	public void loadImage(){
		...
		try {
			bufferLogo = ImageIO.read(new File("image" + File.separator+ "logo3.png"));
			bufferPlayer = ImageIO.read(new File("image" + File.separator+ "qiuyuan_l.png"));
			bufferPlayerD = ImageIO.read(new File("image" + File.separator+ "qiuyuan_d.png"));
			bufferTeam = ImageIO.read(new File("image" + File.separator+ "qiudui_l.png"));
			bufferTeamD = ImageIO.read(new File("image" + File.separator+ "qiudui_d.png"));
			bufferplayerStat = ImageIO.read(new File("image" + File.separator+ "qiuyuantongji_l.png"));
			bufferplayerStatD = ImageIO.read(new File("image" + File.separator+ "qiuyuantongji_d.png"));
			bufferTeamStat = ImageIO.read(new File("image" + File.separator+ "qiuduitongji_l.png"));
			bufferTeamStatD = ImageIO.read(new File("image" + File.separator+ "qiuduitongji_d.png"));
			bufferStat = ImageIO.read(new File("image" + File.separator+ "tongji_l.png"));
			bufferStatD = ImageIO.read(new File("image" + File.separator+ "tongji_d.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public void initButton(){
		...
		MouseHandle statListener = new MouseHandle(statisticsIconD, statisticsIcon, 1);
		...
		MouseHandle playerStatListener = new MouseHandle(playerStatisticsIconD, playerStatisticsIcon, 1);
		...
		MouseHandle teamStatListener = new MouseHandle(teamStatisticsIconD, teamStatisticsIcon, 1);
		...
		MouseHandle playerListener = new MouseHandle(playerIconD, playerIcon, 1);
		...
		MouseHandle teamListener = new MouseHandle(teamIconD, teamIcon, 1);

...
public interface BLservice extends Remote {
	 ...
	 * @param number
	 *            number为人数
	 * @return 返回一个TodayPlayervo，存储某个球队某一天的比赛数据 如果今日没有比赛，则返回过去最近一日的数据王
	 * 
	 * @throws RemoteException
	 *             rmi服务器连接异常
	 */
	 ...
	 *            是否为季后赛
	 * @return 
	 *         返回的Playervo中为当前赛季该球员的所有属性,此时Playervo中的getPlayerItem为null,即球员的历史数据在此接口不提供
	 ...
	 * @param isplayoff
	 *            是否为季后赛
	 * @return 内线(中锋加上大前锋能力综合(综合能力即为playervo中的getREP()))、外线(其他位置能力综合(
	 *         综合能力即为playervo中的getREP()))、
	 ...
	 */
	public double getTeamPoints(String teamName1,
			String season,boolean isPlayOff) throws RemoteException;

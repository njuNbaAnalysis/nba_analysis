...
//	
	...
	public void testGetAllMatchByTime() {
		MatchReader mr = new MatchReader();
		ArrayList<String> list = mr.getMatchesByTime("1985-10-25");
		boolean result = (list.size() != 0);
		System.out.println(list.size()+"DASDASD");
		assertTrue(result);
	}
	...
	public void testGetAllMatchByTime2() {
		MatchReader mr = new MatchReader();
		ArrayList<String> list = mr.getMatchesByTime("1985-10-28");
		boolean result = (list.size() == 0);
		System.out.println(list.size());
		assertTrue(result);
	}
	...
	public void testGetMatchesByTeam() {
		MatchReader mr = new MatchReader();
		ArrayList<String> m = mr.getMatchesByTeam("CLE", "14-15", true, 10);

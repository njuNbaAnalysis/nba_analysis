...
public class DataFactory {
	...
	public static void getallmatches() {
		...
		for (String token : list) {
			...
			insertmatchlist(new match(Mid, date, season, home_team, away_team,
					isplayoff, home_points, away_points));
			numberOfId++;
		}
	}

	public static void insertmatchitem(String Mid, Boolean ishome, String[] num) {
//		Connection conn = DataConnect.GetConnection();
		String sql = "insert into matchitem(`Mid`, `ishome`, `Pid`, `isstart`, `time`, `fieldGoalspercent`, `fieldGoalsAttempt`, `fieldGoalsHit`, `threepointpercent`, `threepointAttempt`, `threepointHit`, `freethrowpercent`, `freethrowAttempt`, `freethrowHit`, `trueshootingpercent`, `rebounds`, `offenseRebounds`, `defenseRebounds`, `assists`, `steals`, `blockShots`, `turnOver`, `fouls`, `points`) "
				+ "values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
		try {
			PreparedStatement pstm = (PreparedStatement) conn
					.prepareStatement(sql);
			pstm.setString(1, Mid);
			pstm.setBoolean(2, ishome);
			pstm.setString(3, num[1]);
			boolean isstart = false;
			if (num[3].trim().equals("1"))
				isstart = true;
			pstm.setBoolean(4, isstart);
			pstm.setDouble(5, getDouble(num[4]));
			pstm.setDouble(6, getDouble(num[5]));
			pstm.setInt(7, getInt(num[6]));
			pstm.setInt(8, getInt(num[7]));
			pstm.setDouble(9, getDouble(num[8]));
			pstm.setInt(10, getInt(num[9]));
			pstm.setInt(11, getInt(num[10]));
			pstm.setDouble(12, getDouble(num[11]));
			pstm.setInt(13, getInt(num[12]));
			pstm.setInt(14, getInt(num[13]));
			pstm.setDouble(15, getDouble(num[14]));
			pstm.setInt(16, getInt(num[15]));
			pstm.setInt(17, getInt(num[16]));
			pstm.setInt(18, getInt(num[17]));
			pstm.setInt(19, getInt(num[18]));
			pstm.setInt(20, getInt(num[19]));
			pstm.setInt(21, getInt(num[20]));
			pstm.setInt(22, getInt(num[21]));
			pstm.setInt(23, getInt(num[22]));
			pstm.setInt(24, getInt(num[23]));
			pstm.executeUpdate();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static void insertpointslist(String Mid, int period,
...
//		Connection conn = DataConnect.GetConnection();
		...
		try {
			PreparedStatement pstm = (PreparedStatement) conn
					.prepareStatement(sql);
			pstm.setString(1, Mid);
			pstm.setInt(2, period);
			pstm.setInt(3, home_points);
			pstm.setInt(4, away_points);
			pstm.executeUpdate();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static void insertmatchlist(match m) {
//		Connection conn = DataConnect.GetConnection();
		...
		try {
			...
			pstm.setString(2, m.getDate());
			pstm.setString(3, m.getSeason());
			pstm.setString(4, m.getHome_team());
			pstm.setString(5, m.getAway_team());
			pstm.setBoolean(6, m.isIsplayoff());
			pstm.setInt(7, m.getHome_points());
			pstm.setInt(8, m.getAway_points());
			pstm.executeUpdate();
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();

		...
		public void initButton() {
			...
			b1.addMouseListener(new MouseAdapter() {
	            ...
	            public void mouseClicked(MouseEvent e) {
	                	...
	                	Playervo p = null;
						try {
							p = MatchPanel.this.bl.getPlayerById(kings[0].getIdOfReboundsKing());
			...
			b2.addMouseListener(new MouseAdapter() {
	            ...
	            public void mouseClicked(MouseEvent e) {
	            	...
	            	Playervo p = null;
					try {
						p = MatchPanel.this.bl.getPlayerById(kings[0].getIdOfPointsKing());
					} catch (RemoteException e1) {
						// TODO 自动生成的 catch 块
						e1.printStackTrace();
					}
			...
			b3.addMouseListener(new MouseAdapter() {
	            ...
	            public void mouseClicked(MouseEvent e) {
	                ...
	                Playervo p = null;
					try {
						p = MatchPanel.this.bl.getPlayerById(kings[0].getIdOfAssistsKing());
					} catch (RemoteException e1) {
						// TODO 自动生成的 catch 块
						e1.printStackTrace();
					}
			...
			b4.addMouseListener(new MouseAdapter() {
	            ...
	            public void mouseClicked(MouseEvent e) {
	                ...
	                Playervo p= null;
					try {
						p = MatchPanel.this.bl.getPlayerById(kings[1].getIdOfPointsKing());
					} catch (RemoteException e1) {
						// TODO 自动生成的 catch 块
						e1.printStackTrace();
					}
			...
			b5.addMouseListener(new MouseAdapter() {
	            ...
	            public void mouseClicked(MouseEvent e) {
	                ...
	                Playervo p=null;
					try {
						p = MatchPanel.this.bl.getPlayerById(kings[1].getNameOfReboundsKing());
					} catch (RemoteException e1) {
						// TODO 自动生成的 catch 块
						e1.printStackTrace();
					}
			...
			b6.addMouseListener(new MouseAdapter() {
	            ...
	            public void mouseClicked(MouseEvent e) {
	                ...
	                Playervo p=null;
					try {
						p = MatchPanel.this.bl.getPlayerById(kings[1].getIdOfAssistsKing());
					} catch (RemoteException e1) {
						// TODO 自动生成的 catch 块
						e1.printStackTrace();
					}
		...
		public void initButton() {						
			...
			live.addMouseListener(new MouseListener() {
				...
				public void mouseReleased(MouseEvent arg0) {
					...
					LivePanel panel = new LivePanel(MatchPanel.this.width, MatchPanel.this.height, MatchPanel.this.bl, match.getMid(),content,season,isPlayOff);
					MatchPanel.this.removeAll();
		...
		public void mousePressed(MouseEvent e) {
			...
			if (type == 3) {
				...
				if (!isFolded) {
					...
					table = new MatchTablePanel(width, 800, matchList.get(index), bl,season,isPlayOff,false);
					unfold(index);

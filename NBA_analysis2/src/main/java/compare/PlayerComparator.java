        ...
        for(Sort token:sortList){
            ...
            case "rebound":
                if(isAvarage){
                    ...
                    else if(o1.getAverageRebounds() > o2.getAverageRebounds()){
                        result = 1;
                    }
                }
                else{
            ...
            case "blockShot":
                if(isAvarage){
                    ...
                    else if(o1.getAverageBlockShots() > o2.getAverageBlockShots()){
                        result = 1;
                    }
                }
                else{
            ...
            case "fault":
                if(isAvarage){
                    ...
                    else if(o1.getAverageTurnOver() > o2.getAverageTurnOver()){
                        result = 1;
                    }
                }
                else{
            ...
            case "efficient":
                if(isAvarage){
                    ...
                    else if(o1.getAverageEfficiency() > o2.getAverageEfficiency()){
                        result = 1;
                    }
                }
                else{
            ...
            case "shot":
                ...
                break;
            case "three":
                if(o1.getThreePointersPercentage() < o2.getThreePointersPercentage()){
                    result = -1;
                }
                else if(o1.getThreePointersPercentage() > o2.getThreePointersPercentage()){
                    result = 1;
                }
                break;
            case "penalty":
            ...
            case "defendRebound":
                if(isAvarage){
                    if(o1.getAverageDefenseRebounds() < o2.getAverageDefenseRebounds()){
                        result = -1;
                    }
                    else if(o1.getAverageDefenseRebounds() > o2.getAverageDefenseRebounds()){
                        result = 1;
                    }
                }
                else{
                    ...
                    else if(o1.getDefenseRebounds() > o2.getDefenseRebounds()){
                        result = 1;
                    }
                }
                break;
            case "offendRebound":
                if(isAvarage){
                    if(o1.getAverageOffenseRebounds() < o2.getAverageOffenseRebounds()){
                        result = -1;
                    }
                    else if(o1.getAverageOffenseRebounds() > o2.getAverageOffenseRebounds()){
                        result = 1;
                    }
                }
                else{
                    ...
                    else if(o1.getOffenseRebounds() > o2.getOffenseRebounds()){
                        result = 1;
                    }
                }
                break;
            case "doubleTwo":
                if(isAvarage){
                    ...
                    else if(o1.getAverageDoubleTwo() > o2.getAverageDoubleTwo()){
                        result = 1;
                    }
                }
                else{
            ...
            case "realShot":
                if(o1.getTrueShootingPercentage() < o2.getTrueShootingPercentage()){
                    result = -1;
                }
                else if(o1.getTrueShootingPercentage() > o2.getTrueShootingPercentage()){
                    result = 1;
                }
                break;
            case "GmSc":
            ...
            case "shotEfficient":
                ...
                else if(o1.getShootingEfficiency() > o2.getShootingEfficiency()){
                    result = 1;
                }
                break;
            case "offendReboundEfficient":
                if(o1.getOffenseReboundsPercentage() < o2.getOffenseReboundsPercentage()){
                    result = -1;
                }
                else if(o1.getOffenseReboundsPercentage() > o2.getOffenseReboundsPercentage()){
                    result = 1;
                }
                break;
            case "defendReboundEfficient":
                if(o1.getDefenseReboundsPercentage() < o2.getDefenseReboundsPercentage()){
                    result = -1;
                }
                else if(o1.getDefenseReboundsPercentage() > o2.getDefenseReboundsPercentage()){
                    result = 1;
                }
                break;
            case "stealEfficient":
            ...
            case "assistEfficient":
                ...
                else if(o1.getAssistsPercentage() > o2.getAssistsPercentage()){
                    result = 1;
                }
                break;
            ...
            case "faultEfficient":
                ...
                else if(o1.getTurnOverPercentage() > o2.getTurnOverPercentage()){
                    result = 1;
                }
                break;
            case "frequency":
                ...
                break;
            default:
                System.out.println("error in PlayerrComparator,unknown field: " + token.getField());
            }

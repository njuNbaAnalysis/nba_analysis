    ...
    public int compare(Team o1, Team o2) {
        for(Sort token:sortList){
            ...
            case "winRate":
                ...
                else if(o1.getWinningPercentage() > o2.getWinningPercentage()){
                    result = 1;
                }
                break;
            case "offendRound":
                if(isAvarage){
                    if(o1.getAverageOffendRounds() < o2.getAverageOffendRounds()){
                        result = -1;
                    }
                    else if(o1.getAverageOffendRounds() > o2.getAverageOffendRounds()){
                        result = 1;
                    }
                }
                else{
            ...
            case "offendEfficient":
                ...
                else if(o1.getOffenseEfficiency() > o2.getOffenseEfficiency()){
                    result = 1;
                }
                break;
            case "defendEfficient":
                ...
                else if(o1.getDefenseEfficiency() > o2.getDefenseEfficiency()){
                    result = 1;
                }
                break;
            ...
            default:
                System.out.println("error in TeamComparator,unknown field: " + token.getField());
            }
